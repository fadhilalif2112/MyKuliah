<div id="add-subject-modal" class="hidden fixed inset-0 z-50 overflow-y-auto">
    <div class="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
        <div class="fixed inset-0 bg-gray-500 bg-opacity-75 transition-opacity" onclick="closeModal('add-subject-modal')">
        </div>
        ...
        <div
            ...
            <div class="bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
                <div class="flex items-center justify-between mb-4">
                    ...
                    <button onclick="closeModal('add-subject-modal')" class="text-gray-400 hover:text-gray-500">
